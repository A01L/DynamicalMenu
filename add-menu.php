                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul id="side-menu">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="add-menu.php" style="border: solid 3px gold;">
                    ...
                    <!-- Start Content-->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Добавить в меню</h4>
                                        <p class="sub-header">
                                            После создание можете редактировать в таблице списков меню.
                                        </p>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <form method="post" action="vendor/sys.php">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="floatingInput" placeholder="Говяжий донер..." name="form1">
                                                    <label for="floatingInput">Название</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" placeholder="500тг.." name="form2">
                                                    <label for="floatingInput">Цена</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <textarea class="form-control" placeholder="Жаренное мясо, базилик, томат..." id="floatingTextarea2"
                                                        style="height: 100px" name="form3"></textarea>
                                                    <label for="floatingTextarea2">Описание</label>
                                                </div>
                                                <div class="mb-3">
                                                        <label for="example-multiselect" class="form-label">Выбирайте категорию</label>
                                                        <select id="example-multiselect" multiple="" class="form-select" name="form4">
                                                            <?php
            $conn = $connect;
...
?>
                                                ...
                                                <input type="text" name="mod" hidden readonly value="add_menu">
                                                <button class="btn btn-warning waves-effect waves-light">Добавить</button>
                                                </form>
